...
setwd("C:/Users/Javie/Documents/1. Trabajo_Universidad/EOI/R Session (Javier Abascal) Sevilla 2018-09-14/R Code")
#######################################################################
...
library(jpeg)
img <- readJPEG("2_grayscale_28x28.jpg")
# 1 & 0 Black & white
# Fijando los valores a Negro o Blanco
black_and_white <- function(x){
...
# Obtenemos la imagen como un vector de 784 columnas
img = t(c(img))
